      ...
      if ImGui.CollapsingHeader('/debug') then
        ...
        if ImGui.TreeNode('minion') then
          ...
          ImGui.NextColumn()
            ...
            edit_switch_temp('weapons', 'maDebug', 'weapons')
          ImGui.NextColumn()
          ImGui.NextColumn()
          ImGui.Columns()
          ImGui.TreePop()
    ...
    currenttargetdata = function (...)
      if ImGui.CollapsingHeader('target data') then
        ...
        if mq.TLO.Target.ID() then
          ...
          ImGui.TextColored(0.39, 0.58, 0.92, 1, 'Name:')
          ImGui.SameLine()
          ImGui.TextColored(1, 1, 1, 1, mq.TLO.Target.Name() or echo.out.tern)        
          -- displayname
          ImGui.TextColored(0.39, 0.58, 0.92, 1, 'DisplayName:')
          ImGui.SameLine()
          ImGui.TextColored(1, 1, 1, 1, mq.TLO.Target.DisplayName() or echo.out.tern)        
          ...
          ImGui.Columns(2, 'noname', false)
            ...
            ImGui.TextColored(0.39, 0.58, 0.92, 1, 'distance:')
            ImGui.SameLine()
            ImGui.TextColored(1, 1, 1, 1, round(mq.TLO.Target.Distance(), 2) or echo.out.tern)   
          ...
          ImGui.NextColumn()
            ...
            --ImGui.SameLine()
            --ImGui.TextColored(1, 1, 1, 1, mq.TLO.Navigation.PathExists(id mq.TLO.Target.ID() ) or 0 )  
            --ImGui.TextColored(1, 1, 1, 1, mq.TLO.Target.ID() or echo.out.tern)  
          ...
          ImGui.Columns(2, 'noname', false)
            ...
            ImGui.TextColored(0.39, 0.58, 0.92, 1, 'Body:')
            ImGui.SameLine()
            ImGui.TextColored(1, 1, 1, 1, mq.TLO.Target.Body() or echo.out.tern)        
